...
//    private BluetoothGattCharacteristic mOTAGattCharacteristic;
    ...
    public UUID SERVICE_UUID = UUID.fromString("73631912-6965-6E65-7269-736669727374");

    public static final String UUID_WRITE_STRING = "00010203-0405-0607-0809-0a0b0c0d2b12";

    public static final UUID CHARACTERISTIC_UUID_WRITE = UUID.fromString("73632B12-6965-6E65-7269-736669727374");
     ...
     * 自定义 OTA结果指令
     */
    public static final int OTA_RESULT = 0xFF03;
...
//        this.enablePcmNotification();
    ...
    protected void onNotify(byte[] data, UUID serviceUUID, UUID characteristicUUID, Object tag) {
        ...
        if (data != null && data.length >= 3) {
            if (data[1] == (byte)((OTA_RESULT >> 8) & 0xff) && data[0] == (OTA_RESULT & 0xff)) {
                if (OtaError.getInstance(data[2]) == OtaError.OTA_SUCCESS) {
                    resetOta();
                    onOtaSuccess();
                } else {
                    resetOta();
