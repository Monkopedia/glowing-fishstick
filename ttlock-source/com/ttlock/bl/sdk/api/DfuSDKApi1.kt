...
//        }
    ...
    private fun getOperationLog(lockData: String?, lockMac: String?) {
        ...
        TTLockClient.Companion.getDefault()
            .getOperationLog(LogType.NEW, lockData, lockMac, object : GetOperationLogCallback {
...
//        });
        TTLockClient.Companion.getDefault()
            .getLockSystemInfo(lockData, null, object : GetLockSystemInfoCallback {
    ...
    private fun recoveryDataByBle(op: Int, json: String?) {
        ...
        upgradeStatus = UpgradeOprationRecovering
        TTLockClient.Companion.getDefault()
            .recoverLockData(json, op, lockData, lockmac, object : RecoverLockDataCallback {
...
//        }, 500);
    ...
    private fun enableLockDfuMode() {
        ...
        TTLockClient.Companion.getDefault()
            .enterDfuMode(lockData, lockmac, object : EnterDfuModeCallback {
