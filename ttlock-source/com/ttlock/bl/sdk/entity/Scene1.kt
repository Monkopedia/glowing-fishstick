...
object Scene {
     ...
     * 门禁
     */
    const val GLASS_LOCK = 4

    /**
     * 保险箱锁
     */
    const val SAFE_LOCK = 5
    const val BICYCLE_LOCK = 6
    const val PARKING_LOCK = 7

    /**
     * 挂锁
     */
    const val PAD_LOCK = 8

    /**
     * 锁芯
     */
    const val CYLINDER = 9

    /**
     * 遥控设备
     */
    const val REMOTE_CONTROL_DEVICE = 10

    /**
     * 同保险箱锁只有单次密码
     */
    const val SAFE_LOCK_SINGLE_PASSCODE = 11
