...
class ConnectParam {
    ...
    private var controlAction = 0
    private var lockModeEnable = false
    private var passageModeConfig: PassageModeConfig? = null
    private var timestamp: Long = 0
    private var autoLockingPeriod = 0
    private var logType = 0
    private var recoveryDataStr: String? = null
    private var recoveryDataType = 0
    private var startDate: Long = 0
    private var endDate: Long = 0
    private var originalPasscode: String? = null
    private var newPasscode: String? = null
    private var attachmentNum: Long = 0
    private var dataJsonStr: String? = null
    private var serverAddress: String? = null
    private var serverPort: Short = 0
    private var lockmac: String? = null

    //    private String factoryDate;
    private var seconds = 0
    private var hotelData: HotelData? = null
    private var ttLockConfigType: TTLockConfigType? = null
    ...
    private var ipSetting: IpSetting? = null
