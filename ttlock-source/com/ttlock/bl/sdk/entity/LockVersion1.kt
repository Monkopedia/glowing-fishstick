...
class LockVersion(
    ...
    companion object {
        var lockVersion_V2S_PLUS = LockVersion(
            5.toByte(), 4.toByte(), 1.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
        var lockVersion_V3 = LockVersion(
            5.toByte(), 3.toByte(), 1.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
        var lockVersion_V2S = LockVersion(
            5.toByte(), 1.toByte(), 1.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
        ...
        var lockVersion_Va = LockVersion(
            0x0a.toByte(), 1.toByte(), 0x07.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
        ...
        var lockVersion_Vb = LockVersion(
            0x0b.toByte(), 1.toByte(), 0x01.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
        var lockVersion_V2 = LockVersion(
            3.toByte(), 0.toByte(), 0.toByte(), 0.toByte()
                .toShort(), 0.toByte().toShort()
        )
        var lockVersion_V3_car = LockVersion(
            5.toByte(), 3.toByte(), 7.toByte(), 1.toByte()
                .toShort(), 1.toByte().toShort()
        )
